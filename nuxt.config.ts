  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:image', content: 'https://blue1st.github.io/arcade-controller-button-placement/ogp.png' },
        ...
        { name: 'twitter:image', content: 'https://blue1st.github.io/arcade-controller-button-placement/ogp.png' }
      ],
      link: [
        {
          rel: 'stylesheet',
